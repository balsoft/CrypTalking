...
window.onload=function(){setTimeout(function(){if(!(document.getElementById("starting")===undefined|document.getElementById("starting")===null)){
	...
	document.querySelector(".s42-dialog__close-btn").onclick = function(){window.location.reload()};
